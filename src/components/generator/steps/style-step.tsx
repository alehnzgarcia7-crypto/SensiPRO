...
const STYLES: StyleOption[] = [
  {
    ...
    name: 'Agresivo',
    icon: Sword,
    description: 'ARES suma +40 a tu base para giros ultrarrápidos. Rush con MP40, M1887, escopetas. Reacción instantánea.',
  ...
  },
  {
    ...
    name: 'Balanceado',
    icon: Target,
    description: 'Tu sensibilidad base sin modificar (+0). El perfil más consistente. ARs, SMGs, ranked. El más recomendado.',
  ...
  },
  {
    ...
    name: 'Francotirador',
    icon: Crosshair,
    description: 'ARES resta -20 a tu base para máxima estabilidad en miras. AWM, Kar98k, Woodpecker. Cada disparo cuenta.',
