...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { text: 'Giroscopio calibrado', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: '9 estilos de calibración completos', included: true },
      ...
      { text: 'Giroscopio calibrado por panel', included: true },
      ...
      { text: 'Headshot Mode COMPLETO (15 armas, 5 técnicas, training plan con timer)', included: true },
