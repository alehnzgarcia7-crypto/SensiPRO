    ...
    <div className="glass-card p-6">
      ...
      <div className="space-y-2">
        <div className="px-3 py-2 rounded-lg bg-white/[0.02] border border-white/[0.04]">
          <p className="text-[10px] font-ui text-slate-600 uppercase tracking-wider mb-0.5">📍 Posición</p>
          <p className="text-xs text-slate-300 font-body">{fireButton.positionEs}</p>
        </div>
        <div className="px-3 py-2 rounded-lg bg-white/[0.02] border border-white/[0.04]">
          <p className="text-[10px] font-ui text-slate-600 uppercase tracking-wider mb-0.5">👆 Drag tip</p>
          <p className="text-xs text-slate-300 font-body">{fireButton.dragTipEs}</p>
        </div>
        <div className="px-3 py-2 rounded-lg bg-white/[0.02] border border-white/[0.04]">
          <p className="text-[10px] font-ui text-slate-600 uppercase tracking-wider mb-0.5">👁️ Transparencia</p>
          <p className="text-xs text-slate-300 font-body">{fireButton.transparency}%</p>
        </div>
      </div>
    </div>
  );
