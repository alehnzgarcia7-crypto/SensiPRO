...
export const metadata: Metadata = {
  ...
  description: 'Genera la sensibilidad perfecta para Free Fire basada en tu dispositivo. 610+ celulares de 21 marcas, calibración por DPI real, 3 estilos de juego y 9 combinaciones de ajuste.',
