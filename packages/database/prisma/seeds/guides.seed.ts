...
const GUIDES: GuideSeed[] = [
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    sections: [
      ...
      {
        title: 'Cómo Afecta tu Dispositivo a la Sensibilidad',
        content: '<p>Tu dispositivo es el factor #1 que determina tu sensibilidad ideal. Aquí están las variables clave:</p><p><strong>Refresh Rate (Hz):</strong> Un dispositivo de 120Hz actualiza la pantalla el doble de veces que uno de 60Hz. Esto significa que el mismo movimiento del dedo se traduce en un movimiento más suave y más distancia recorrida en pantalla. Si pasas de 60Hz a 120Hz, necesitas bajar tu sensibilidad entre un 10-15% para mantener el mismo "feel".</p><p><strong>Tamaño de Pantalla:</strong> En una pantalla de 6.8" tu dedo recorre más distancia física que en una de 5.5" para el mismo swipe. Pantallas más grandes necesitan sensibilidades ligeramente más altas para compensar. Regla general: por cada pulgada extra, sube la sensibilidad un 3-5%.</p><p><strong>RAM:</strong> Dispositivos con poca RAM (2-3GB) sufren frame drops durante combates intensos. Cuando los FPS bajan, la sensibilidad se siente inconsistente — a veces rápida, a veces lenta. La solución es usar sensibilidades más bajas y conservadoras para minimizar el impacto de los drops.</p><p><strong>Panel (LCD vs AMOLED):</strong> Las pantallas AMOLED tienen menor latencia de respuesta al touch que las LCD. Esto significa que el input se registra más rápido, haciendo que la misma sensibilidad se sienta ligeramente más responsiva en AMOLED. Si cambias de LCD a AMOLED, baja tu sensibilidad un 2-3%.</p><p><strong>Resolución y DPI:</strong> Pantallas con mayor PPI (pixels por pulgada) hacen que la misma sensibilidad se sienta más lenta porque hay más píxeles que recorrer. Una pantalla Full HD (1080p) necesita valores ligeramente más altos que una HD (720p).</p>',
        orderIndex: 1,
        isPremium: false,
      },
      {
        title: 'Método de Calibración PRO (5 Pasos)',
        content: '<p>Este es el método que usan los jugadores competitivos para calibrar su sensibilidad en 15-20 minutos:</p><p><strong>Paso 1 — Base 100:</strong> Pon TODOS los sliders en 100 (centro de la escala 0-200). Este es tu punto de partida neutral. No pongas valores random ni copies de internet.</p><p><strong>Paso 2 — General primero:</strong> Ve a la sala de entrenamiento. Párate frente a un poste o pared con una marca visible. Intenta girar 180° con un solo swipe del dedo sin levantar. Si giras demasiado, baja 10. Si no llegas, sube 10. Repite hasta que un swipe te gire exactamente 180°.</p><p><strong>Paso 3 — Punto Rojo:</strong> Equipa una AR con punto rojo. Apunta a un objetivo estático a 20m. Intenta mantener el crosshair en el centro mientras disparas un cargador completo. Si se desvía demasiado fácil, baja. Si te cuesta seguir a un bot moviéndose, sube. La clave: debes poder controlar el spray completo de un M4A1 sin que la mira se escape.</p><p><strong>Paso 4 — Scopes:</strong> Repite el proceso con scope 2x a 50m, scope 4x a 100m. Cada scope necesita más precisión que el anterior. Regla general: reduce 10-15 puntos por cada nivel de zoom.</p><p><strong>Paso 5 — AWM/Sniper:</strong> Equipa un AWM. Apunta a un objetivo estático a 150m+. Debes poder mover el scope con precisión para hacer micro-ajustes sin que se mueva de más. Un buen test: intenta apuntar a la cabeza de un bot parado lejos. Si puedes mantener la mira estable en la cabeza durante 2 segundos, está bien.</p><p><strong>Paso Final — Free Look:</strong> Corre en línea recta y usa Free Look para mirar a los costados. Debe ser lo suficientemente rápido para ver amenazas a los lados sin perder el control. Valores entre 150-185 funcionan para la mayoría.</p><p><strong>Importante:</strong> Una vez que tengas tus valores, NO los cambies por al menos 3-5 días. Tu memoria muscular necesita tiempo para adaptarse. Cambiar la sensibilidad cada partida es el peor error que puedes cometer.</p>',
        orderIndex: 2,
        isPremium: true,
      },
    ],
  },
  {
    ...
    sections: [
      ...
      {
        title: 'Valores por Tipo de Dispositivo',
        content: '<p>Aquí están las recomendaciones específicas basadas en el hardware real de tu celular:</p><p><strong>Gama baja (2-3GB RAM, 60Hz, LCD):</strong> General 90-110 | Punto Rojo 95-115 | Scope 2x 85-105 | Scope 4x 80-100 | Sniper 75-95 | Free Look 100-120. Prioridad: estabilidad. Los frame drops hacen que sensibilidad alta sea inconsistente.</p><p><strong>Gama media (4-6GB RAM, 90Hz):</strong> General 110-140 | Punto Rojo 120-155 | Scope 2x 110-140 | Scope 4x 105-135 | Sniper 100-130 | Free Look 130-160. Zona balanceada: tienes FPS estables para aprovechar sensibilidad media.</p><p><strong>Gama alta (8GB+ RAM, 120Hz, AMOLED):</strong> General 150-180 | Punto Rojo 160-190 | Scope 2x 150-175 | Scope 4x 145-170 | Sniper 140-165 | Free Look 165-190. Máximo rendimiento: los frames estables y la baja latencia permiten aprovechar sensibilidad alta.</p><p><strong>Gama ultra (12GB+ RAM, 144Hz, LTPO):</strong> General 165-195 | Punto Rojo 175-200 | Scope 2x 160-185 | Scope 4x 155-180 | Sniper 150-175 | Free Look 180-200. Nivel pro: tu hardware no te limita, la sensibilidad depende 100% de tu habilidad y preferencia.</p>',
        orderIndex: 2,
        isPremium: true,
      },
    ],
  ...
  {
    title: 'Sensibilidad por RAM: Por Qué tu Dispositivo Importa',
    slug: 'sensibilidad-por-ram-dispositivo-importa',
    description: 'La RAM de tu celular afecta directamente qué sensibilidad deberías usar. Aprende la relación entre hardware y gameplay.',
    category: 'SENSITIVITY',
    content: '<p>La RAM de tu dispositivo es uno de los factores más subestimados al configurar la sensibilidad en Free Fire. Un celular con 3GB de RAM se comporta de forma radicalmente diferente a uno con 12GB, y tu sensibilidad debe reflejar esa diferencia. Esta guía explica por qué y cómo ajustar.</p>',
    readTimeMin: 7,
    isPremium: false,
    sections: [
      {
        title: 'RAM y Frame Rate: La Conexión Oculta',
        content: '<p>La RAM no solo determina si puedes abrir el juego — determina qué tan estables son tus FPS durante el gameplay. Free Fire en gráficos "Suave" consume aproximadamente 1.5-2GB de RAM. Si tu celular tiene 3GB, el sistema operativo ya está usando 1.5GB, dejándote apenas lo justo para el juego.</p><p>Cuando la RAM se agota, tu celular empieza a hacer "memory swapping" — moviendo datos entre la RAM y el almacenamiento, lo que causa micro-freezes. Estos freezes duran milisegundos pero son fatales en un combate: durante ese freeze, tu sensibilidad se "salta" porque el juego no registró los frames intermedios.</p><p><strong>El impacto real:</strong> Un celular de 3GB RAM puede tener caídas de 60 a 25 FPS durante combates intensos (múltiples jugadores, granadas, gloo walls). Durante esa caída, tu sensibilidad se siente 2-3 veces más rápida porque el juego "salta" frames. Con sensibilidad alta (170+), esos saltos te hacen perder completamente el control.</p><p>Por eso, dispositivos con menos RAM necesitan sensibilidades más conservadoras: para que los momentos de frame drop no te saquen del combate.</p>',
        orderIndex: 0,
        isPremium: false,
      },
      {
        title: 'Tabla de Sensibilidad por RAM',
        content: '<p>Basado en análisis de rendimiento real, estas son las recomendaciones optimizadas por cantidad de RAM:</p><p><strong>2GB RAM:</strong> General 80-100. Gráficos obligatorios en Suave + FPS Normal. Tu prioridad es consistencia, no velocidad. Evita combates a larga distancia donde necesitarías scope alto.</p><p><strong>3GB RAM:</strong> General 90-110. Gráficos Suave + FPS Alto. Puedes ser un poco más agresivo pero mantén margen para los drops.</p><p><strong>4GB RAM:</strong> General 100-130. Gráficos Suave + FPS Alto. Aquí empiezas a tener libertad real. Los drops son menos frecuentes y menos severos.</p><p><strong>6GB RAM:</strong> General 120-155. Gráficos Estándar + FPS Ultra. Zona cómoda. FPS estables la mayor parte del tiempo. Puedes empezar a experimentar con sensibilidad media-alta.</p><p><strong>8GB RAM:</strong> General 145-175. Gráficos HD + FPS Ultra. Performance consistente. Tu sensibilidad puede ser agresiva sin miedo a inconsistencias.</p><p><strong>12GB+ RAM:</strong> General 160-195. Sin limitaciones de hardware. La sensibilidad depende 100% de tu habilidad y preferencia personal.</p>',
        orderIndex: 1,
        isPremium: false,
      },
      {
        title: 'Optimizar RAM para Mejor Rendimiento',
        content: '<p>Antes de ajustar tu sensibilidad, optimiza tu RAM disponible:</p><p><strong>1. Cierra todas las apps:</strong> WhatsApp, Instagram, TikTok — cada una consume 200-500MB de RAM. Ciérralas desde el administrador de tareas, no solo minimizarlas.</p><p><strong>2. Desactiva sincronización:</strong> Gmail, Drive, fotos — la sincronización en segundo plano consume RAM constantemente.</p><p><strong>3. Usa modo gaming:</strong> Samsung Game Booster, Xiaomi Game Turbo, etc. Estos modos cierran procesos en segundo plano y priorizan el juego.</p><p><strong>4. Reinicia antes de jugar:</strong> Un reinicio limpia la RAM fragmentada. Es la forma más rápida de ganar 200-400MB extra.</p><p><strong>5. Evita widgets:</strong> Los widgets del home screen consumen RAM permanentemente. Elimina los que no uses.</p><p>Cada una de estas optimizaciones puede darte 100-300MB extra de RAM, lo que se traduce en FPS más estables y sensibilidad más consistente.</p>',
        orderIndex: 2,
        isPremium: true,
      },
    ],
