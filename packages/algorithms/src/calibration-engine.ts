...
// v5.0: Free View ahora participa en calibración (está en escala 0-200)
...
// v5.0: Free View ahora participa en reducción DPI (está en escala 0-200)
...
export function generateAllCalibrations(
  ...
  return {
    ...
    meta: {
      ...
      algorithm: 'ARES-v5.0-calibration',
    },
  };
}
