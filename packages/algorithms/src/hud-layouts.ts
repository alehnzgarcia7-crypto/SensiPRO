...
const HUD_2_FINGERS: HudLayout = {
  ...
  buttons: [
    ...
    { id: 'fire', nameEs: 'Disparar', x: 82, y: 58, size: 60, transparency: 60, priority: 'critical', fingerEs: 'Pulgar Der', color: '#EF4444' },
  ...
  proTipsEs: [
    ...
    'Botón de Disparo al 55-75% según tu pantalla. Agresivo: más grande. Sniper: más chico.',
...
const HUD_3_FINGERS: HudLayout = {
  ...
  buttons: [
    ...
    { id: 'fire', nameEs: 'Disparar', x: 82, y: 56, size: 52, transparency: 55, priority: 'critical', fingerEs: 'Pulgar Der', color: '#EF4444' },
  ...
  proTipsEs: [
    ...
    'Fire button al 43-65% según pantalla y playstyle. Rusher: más grande. Sniper: más chico.',
...
const HUD_4_FINGERS: HudLayout = {
  ...
  buttons: [
    ...
    { id: 'fire', nameEs: 'Disparar', x: 83, y: 7, size: 48, transparency: 55, priority: 'critical', fingerEs: 'Índice Der', color: '#10B981' },
  ...
  proTipsEs: [
    ...
    'Fire button al 39-60% según pantalla. El índice tiene más precisión que el pulgar.',
